...
//----------------------------------------------------------------------------------------
//! \fn Reconstruction::PiecewiseParabolicX1_DustFluids(const int k, const int j,
...
void Reconstruction::PiecewiseParabolicX1_DustFluids(
  ...
  AthenaArray<Real> &q_im2  = scr2_ni_df_, &q_im1  = scr3_ni_df_,
                    &q_i    = scr4_ni_df_, &q_ip1  = scr5_ni_df_, &q_ip2 = scr6_ni_df_,
...
//-------------------------------------------------------------------------------------
//! \fn Reconstruction::PiecewiseParabolicX2_DustFluids(const int k, const int j,
//!                              const int il, const int iu,
//!                              const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
//!                              AthenaArray<Real> &wl, AthenaArray<Real> &wr)
...
void Reconstruction::PiecewiseParabolicX2_DustFluids(
  ...
  // set work arrays used for primitive/characterstic cell-averages to scratch
  AthenaArray<Real> &q_jm2  = scr2_ni_df_, &q_jm1  = scr3_ni_df_,
                    &q_j    = scr4_ni_df_, &q_jp1  = scr5_ni_df_, &q_jp2 = scr6_ni_df_,
...
//----------------------------------------------------------------------------------------
//! \fn Reconstruction::PiecewiseParabolicX3_DustFluids(const int k, const int j,
//!                              const int il, const int iu,
//!                              const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
//!                              AthenaArray<Real> &wl, AthenaArray<Real> &wr)
...
void Reconstruction::PiecewiseParabolicX3_DustFluids(
  ...
  // set work arrays used for primitive/characterstic cell-averages to scratch
  AthenaArray<Real> &q_km2  = scr2_ni_df_, &q_km1  = scr3_ni_df_,
                    &q_k    = scr4_ni_df_, &q_kp1  = scr5_ni_df_, &q_kp2 = scr6_ni_df_,
